            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Rating</label>
                            <input type="number" name="rating" class="form-control" step="0.1" value="<?php echo htmlspecialchars($client['rating']); ?>">
                        </div>
                        <div class="form-group">
                            <label>Sort Order</label>
                            <input type="number" name="sort_order" class="form-control" value="<?php echo htmlspecialchars($client['sort_order']); ?>">
                        </div>
